 ...
 */
final class Version20221103082949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCEC9EFB04B3889 ON personne (num_securite_sociale)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCEC9EF228D8C5E ON personne (num_adeli)');
    }
